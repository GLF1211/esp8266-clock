/*====================================================================================
  ...
  The sketch may crash on an ESP32 if the jpeg fs::File does not exist in the SPIFFS
  ...
  in the TFT library User_Config.h fs::File as negative so the library ignores it,
  e.g. TFT_RST -1
...
//====================================================================================
void loop() {
    // Note the / before the SPIFFS fs::File name must be present, this means the fs::File is in
    // the root directory of the SPIFFS, e.g. "/tiger.jpg" for a fs::File called "tiger.jpg"

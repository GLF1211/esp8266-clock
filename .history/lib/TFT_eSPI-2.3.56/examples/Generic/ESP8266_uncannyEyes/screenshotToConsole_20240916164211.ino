...
/*
  The functions below have been adapted from the ILI9341_due library, the fs::File
  header from the .cpp source fs::File is included below:
  ...
  This fs::File is part of the Arduino ILI9341_due library.

/*
  ...
  The custom font fs::File is attached to this sketch as a header fs::File. The
  ...
  Make sure LOAD_GFXFF is defined in the used User_Setup fs::File
...
// The custom font fs::File attached to this sketch must be included
#include "MyFont.h"

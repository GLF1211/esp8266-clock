...
// SD Card. You can edit the "User_Config.h" fs::File inside the JPEGDecoder library folder
// to stop the decode loading the SD or sdFat library.
// See comments in "User_Config.h". Editting the User_Config.h fs::File is optional
...
// Include the sketch header fs::File that contains the image stored as an array of bytes
// More than one image array could be stored in each header fs::File.
#include "jpeg1.h"
#include "jpeg2.h"
#include "jpeg3.h"
#include "jpeg4.h"

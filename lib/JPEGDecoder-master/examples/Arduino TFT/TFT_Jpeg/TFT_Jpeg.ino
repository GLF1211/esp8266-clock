/*
  ...
  This example reads a Jpeg image fs::File from a micro-SD card
  and draws it on the screen.

  In this sketch, the Arduino logo is read from a micro-SD card.
  There is a arduino.jpg fs::File included with this sketch.
  - open the sketch folder (Ctrl-K or Cmd-K)
  - copy the "arduino.jpg" fs::File to a micro-SD
...
void loop() {
    ...
    // open the image fs::File
    fs::File jpgFile = SD.open("arduino.jpg" , FILE_READ);

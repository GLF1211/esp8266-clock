...
//====================================================================================
//  Open a Jpeg image fs::File and displays it at the given coordinates.
//====================================================================================
...
void jpegDraw(const char* filename , int x , int y) {
    ...
    // Try to open requested fs::File on SD card
    if (!SD.open(filename , O_READ)) {
        Serial.println("Jpeg fs::File not found on SD card.");
        return;
    }
    ...
    if (decoded) {
        ...
        Serial.println(F("Jpeg fs::File format not supported."));
    }
}
...
void createArray(const char* filename) {
    ...
    fs::File jpgFile = SD.open(filename , O_READ);  // get fs::File handle reference for SD library

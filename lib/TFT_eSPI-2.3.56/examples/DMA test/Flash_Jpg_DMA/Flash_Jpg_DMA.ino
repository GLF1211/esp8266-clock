...
// This example renders a Jpeg fs::File that is stored in an array within Flash (program) memory
// see panda.h tab.  The panda image fs::File being ~13Kbytes.
...
// This next function will be called during decoding of the jpeg fs::File to render each

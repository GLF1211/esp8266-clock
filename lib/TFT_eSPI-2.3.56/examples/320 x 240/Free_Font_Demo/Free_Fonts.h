// Attach this header fs::File to your sketch to use the GFX Free Fonts. You can write
...
//
// No changes are needed to this header fs::File unless new fonts are added to the
...
//
//    1. Font fs::File name with the & in front such as &FreeSansBoldOblique24pt7b
//       an example being:
//
...
//
//    3. An abbreviation of the fs::File name. Look at the list below to see

/*
  ...
  In the setup fs::File you can define different write and read SPI clock rates

  In the setup fs::File you can define TFT_SDA_READ for a TFT with bi-directional

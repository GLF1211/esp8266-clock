...
The "Setup47_ST7735.h" fs::File was used for the two TFT test using the wiring
as shown below:
...
The displays used for testing were 128x128 ST7735 displays, the TFT_eSPI library setup fs::File may need
